...
c5 <- read_rds("Data/30min_trkpts_formatted") %>% 
  filter(year=="2017",
         individual.local.identifier=="CE_wet",
         month(timestamp) == 7,
         date(timestamp) < date("2017-07-08")) %>%  # 10 unique days
  mutate(individual.local.identifier = "C4") %>%
  as.telemetry(projection = "+proj=utm +zone=16 +north +datum=WGS84 +units=m +no_defs +ellps=WGS84 +towgs84=0,0,0")
...
saveRDS(FITSa, "Intermediate/FITS_aa_redo2.rds")
saveRDS(FITSc, "Intermediate/FITS_ce_redo2.rds")
saveRDS(FITSr, "Intermediate/FITS_rr_redo2.rds")
saveRDS(FITSa2, "Intermediate/FITS_aa2_redo2.rds")
saveRDS(FITSs, "Intermediate/FITS_sp_redo2.rds")
saveRDS(FITSf, "Intermediate/FITS_fl_redo2.rds")
saveRDS(AKDEa, "Intermediate/AKDE_aa_redo2.rds")
saveRDS(AKDEc, "Intermediate/AKDE_ce_redo2.rds")
saveRDS(AKDEr, "Intermediate/AKDE_rr_redo2.rds")
saveRDS(AKDEa2, "Intermediate/AKDE_aa2_redo2.rds")
saveRDS(AKDEs, "Intermediate/AKDE_sp_redo2.rds")
saveRDS(AKDEf, "Intermediate/AKDE_fl_redo2.rds")
saveRDS(AA, "Intermediate/DATA_aa_redo2.rds")
saveRDS(CE, "Intermediate/DATA_ce_redo2.rds")
saveRDS(RR, "Intermediate/DATA_rr_redo2.rds")
saveRDS(AA2, "Intermediate/DATA_aa2_redo2.rds")
saveRDS(SP, "Intermediate/DATA_sp_redo2.rds")
saveRDS(FL, "Intermediate/DATA_fl_redo2.rds")
