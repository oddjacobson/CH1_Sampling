...
levels.1 <- c("Low (21 or -1.3std)", "Med (203 or -0.55std)", "High (385 or 0.2std)")
...
p1 <- ggplot(ame_locs_clumped, aes(x = .value, 
  ...
  labs(x = "Instantaneous Slope Coefficients", 
       y = "Density", fill = "Amount of Locations",
...
levels.2 <- c("Low (1 or -1.3std)", "Med (3 or -0.55std)", "High (6 or 0.2std)")
...
p3 <- ggplot(ame_weeks_clumped, aes(x = .value, 
  ...
  coord_cartesian(xlim = c(-0.05,0.5)) +
  labs(x = "Instantaneous Slope Coefficients", 
       y = "Density", fill = "Amount of Weeks",
       title = "C") +
  theme_bw(base_family = "ArcherPro Book") +
