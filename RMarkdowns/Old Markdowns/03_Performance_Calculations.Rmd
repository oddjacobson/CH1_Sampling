...
FITSc <- readRDS("Intermediate/FITS_ce.rds")
...
AKDEc <- readRDS("Intermediate/AKDE_ce.rds")
...
## Plot Home Range Performance Maps

The plots show the 95% UD estimates with 95% CIs using the data from the different sampling regimes. 
Each plot shows the total locations from the high-quality sample, but the yellow points are the ones that were selected in the regime, and the red points are the one's that were thinned out.
...
ggplot() +
  geom_sf(data = aa_all_data, aes(color = "missing points"), size = 1.5, inherit.aes = FALSE, alpha = 0.3, size = 0.3) +
  geom_sf(data = aa_data_sf, aes(color = "used points"), size = 1.5, alpha = 0.8, inherit.aes = FALSE, alpha = 0.3, size = 0.3) +
  geom_sf(data = aa_akde_CI, fill = NA, linetype = "dashed", inherit.aes = FALSE, alpha = 0.3, size = 0.3) +
  geom_sf(data = aa_akde_sf, fill =NA , inherit.aes = FALSE, alpha = 0.06, size = 0.8) +
  ggspatial::annotation_scale(location = "bl", width_hint = 0.3,height = unit(4,'pt'),
                              style = 'ticks') +
  ...
  labs( x = "Easting (km)", y = "Northing (km)", title = "AA") +
...
Get boundaries, points, and change to sf object
...
ggplot() +
  geom_sf(data = ce_all_data, aes(color = "missing points"), size = 1.5, inherit.aes = FALSE, alpha = 0.3, size = 0.3) +
  geom_sf(data = ce_data_sf, aes(color = "used points"), size = 1.5, alpha = 0.8, inherit.aes = FALSE, alpha = 0.3, size = 0.3) +
  geom_sf(data = ce_akde_CI, fill = NA, linetype = "dashed", inherit.aes = FALSE, alpha = 0.3, size = 0.3) +
  geom_sf(data = ce_akde_sf, fill =NA , inherit.aes = FALSE, alpha = 0.06, size = 0.8) +
  ggspatial::annotation_scale(location = "bl", width_hint = 0.3,height = unit(4,'pt'),
                              style = 'ticks') +
  coord_sf(datum = st_crs("+proj=utm +zone=16 +north +datum=WGS84 +units=km +no_defs +ellps=WGS84 +towgs84=0,0,0"), 
  ...
  scale_y_continuous(labels = scales::label_number(accuracy = .1, big.mark = "")) +
  guides(color=guide_legend(override.aes=list(size = 3)))+
  labs( x = "Easting (km)", y = "Northing (km)", title = "CE") +
  theme_bw(base_family = "ArcherPro Book") +
  theme(legend.position="bottom", 
        legend.title = element_blank(),
        axis.text.x = element_text(angle=45, hjust = 1),
...
ggplot() +
  geom_sf(data = rr_all_data, aes(color = "missing points"), size = 1.5, inherit.aes = FALSE, alpha = 0.3, size = 0.3) +
  geom_sf(data = rr_data_sf, aes(color = "used points"), size = 1.5, alpha = 0.8, inherit.aes = FALSE, alpha = 0.3, size = 0.3) +
  geom_sf(data = rr_akde_CI, fill = NA, linetype = "dashed", inherit.aes = FALSE, alpha = 0.3, size = 0.3) +
  geom_sf(data = rr_akde_sf, fill =NA , inherit.aes = FALSE, alpha = 0.06, size = 0.8) +
  ggspatial::annotation_scale(location = "bl", width_hint = 0.3,height = unit(4,'pt'),
                              style = 'ticks') +
  coord_sf(datum = st_crs("+proj=utm +zone=16 +north +datum=WGS84 +units=km +no_defs +ellps=WGS84 +towgs84=0,0,0"), 
  ...
  scale_y_continuous(labels = scales::label_number(accuracy = .1, big.mark = "")) +
  guides(color=guide_legend(override.aes=list(size = 3)))+
  labs( x = "Easting (km)", y = "Northing (km)", title = "RR") +
  theme_bw(base_family = "ArcherPro Book") +
  theme(legend.position="bottom", 
        legend.title = element_blank(),
        axis.text.x = element_text(angle=45, hjust = 1),
...
ggplot() +
  geom_sf(data = aa2_all_data, aes(color = "missing points"), size = 1.5, inherit.aes = FALSE, alpha = 0.3, size = 0.3) +
  geom_sf(data = aa2_data_sf, aes(color = "used points"), size = 1.5, alpha = 0.8, inherit.aes = FALSE, alpha = 0.3, size = 0.3) +
  geom_sf(data = aa2_akde_CI, fill = NA, linetype = "dashed", inherit.aes = FALSE, alpha = 0.3, size = 0.3) +
  geom_sf(data = aa2_akde_sf, fill =NA , inherit.aes = FALSE, alpha = 0.06, size = 0.8) +
  ggspatial::annotation_scale(location = "bl", width_hint = 0.3,height = unit(4,'pt'),
                              style = 'ticks') +
  coord_sf(datum = st_crs("+proj=utm +zone=16 +north +datum=WGS84 +units=km +no_defs +ellps=WGS84 +towgs84=0,0,0"), 
           xlim=c(676.500,680.000), ylim=c(1161.000, 1164.000)) +
  ...
  scale_y_continuous(labels = scales::label_number(accuracy = .1, big.mark = "")) +
  guides(color=guide_legend(override.aes=list(size = 3)))+
  labs( x = "Easting (km)", y = "Northing (km)", title = "AA2") +
  theme_bw(base_family = "ArcherPro Book") +
  theme(legend.position="bottom", 
        legend.title = element_blank(),
        axis.text.x = element_text(angle=45, hjust = 1),
...
ggplot() +
  geom_sf(data = fl_all_data, aes(color = "missing points"), size = 1.5, inherit.aes = FALSE, alpha = 0.3, size = 0.3) +
  geom_sf(data = fl_data_sf, aes(color = "used points"), size = 1.5, alpha = 0.8, inherit.aes = FALSE, alpha = 0.3, size = 0.3) +
  geom_sf(data = fl_akde_CI, fill = NA, linetype = "dashed", inherit.aes = FALSE, alpha = 0.3, size = 0.3) +
  geom_sf(data = fl_akde_sf, fill =NA , inherit.aes = FALSE, alpha = 0.06, size = 0.8) +
  ggspatial::annotation_scale(location = "bl", width_hint = 0.3,height = unit(4,'pt'),
                              style = 'ticks') +
  coord_sf(datum = st_crs("+proj=utm +zone=16 +north +datum=WGS84 +units=km +no_defs +ellps=WGS84 +towgs84=0,0,0"), 
  ...
  scale_y_continuous(labels = scales::label_number(accuracy = .1, big.mark = "")) +
  guides(color=guide_legend(override.aes=list(size = 3)))+
  labs( x = "Easting (km)", y = "Northing (km)", title = "FL") +
  theme_bw(base_family = "ArcherPro Book") +
  theme(legend.position="bottom", 
        legend.title = element_blank(),
        axis.text.x = element_text(angle=45, hjust = 1),
...
ggplot() +
  geom_sf(data = sp_all_data, aes(color = "missing points"), size = 1.5, inherit.aes = FALSE, alpha = 0.3, size = 0.3) +
  geom_sf(data = sp_data_sf, aes(color = "used points"), size = 1.5, alpha = 0.8, inherit.aes = FALSE, alpha = 0.3, size = 0.3) +
  geom_sf(data = sp_akde_CI, fill = NA, linetype = "dashed", inherit.aes = FALSE, alpha = 0.3, size = 0.3) +
  geom_sf(data = sp_akde_sf, fill = NA, inherit.aes = FALSE, alpha = 0.06, size = 0.8) +
  ggspatial::annotation_scale(location = "bl", width_hint = 0.3,height = unit(4,'pt'),
                              style = 'ticks') +
  coord_sf(datum = st_crs("+proj=utm +zone=16 +north +datum=WGS84 +units=km +no_defs +ellps=WGS84 +towgs84=0,0,0"), 
  ...
  scale_x_continuous(labels = scales::label_number(accuracy = .1)) +
  scale_y_continuous(labels = scales::label_number(accuracy = .1, big.mark = "")) +
  labs( x = "Easting (km)", y = "Northing (km)", title = "SP") +
  guides(color=guide_legend(override.aes=list(size = 3)))+
  theme_bw(base_family = "ArcherPro Book") +
  theme(legend.position="bottom", 
        legend.title = element_blank(),
